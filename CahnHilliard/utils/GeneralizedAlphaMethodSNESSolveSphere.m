function [C_n1, Cdot_n1] = GeneralizedAlphaMethodSNESSolveSphere( PHUTelem, basisFun, sizeBasis, p, q,theta,alpha,C_n,Cdot_n,C_n1,Cdot_n1,CalphaF,CalphaM,alphaM,alphaF,gamma,timeStep)
repeat=1;
count=0;
tol=10e-3;
while repeat
...
%     tic
%     [residual] = assembleResidualCahnHilliard2(PHUTelem, GIFTmesh, sizeBasis, p, q, CalphaF, CalphaM, theta, alpha);
%     toc
%     disp('Tangent...')
%     tic
%     [tangent] = assembleTangentCahnHilliard2b(PHUTelem, basisFun, sizeBasis, p, q, CalphaF, CalphaM, theta, alpha, shift);
%     toc
    norm(residual)
