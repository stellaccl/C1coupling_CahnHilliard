function [stiff, rhs ] = assembleBiharmonic_squareWith2Holes_degElev(PHTelem,GIFTmesh, sizeBasis, p, q )
%use nodesGlobal
%use modifiedC
        ...
        if isempty(PHTelem{patchIndex}(elemIndex).children)
            ...
            for jj=1:ngauss_y
                for ii=1:ngauss_x
                   ...
                   [~,~,d4udx4,d4udy4,d4udx2dy2]=computeDerivativesSquareWith2HolesBiharmonic(coords(1),coords(2));
