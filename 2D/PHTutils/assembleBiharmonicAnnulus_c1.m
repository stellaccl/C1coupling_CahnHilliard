function [stiff, rhs ] = assembleBiharmonicAnnulus_c1(PHTelem,GIFTmesh, sizeBasis, p, q )
                ...
                for jjj=1:nument
                    ...
                    for jj=1:ngauss_y
                        for ii=1:ngauss_x
                            ...
                            localStiffTemp=localStiffTemp+(Na_xx+Na_yy)*(Nb_xx+Nb_yy)*scalefac*gauss_weight_x(ii).*gauss_weight_y(jj).*J;
                            
                        end
                    end
                    localStiff(iii,jjj)=localStiffTemp;
                end
            end
