function [ coefSol ] = zipConformingC1_boundaryCondition_pinchedCylinder( PHUTelem,m,p,q )
...
list=[list,PHUTelem{1}(elemUpPatch1).solIndex(up_nodes2)];
list=[list,PHUTelem{2}(elemUpPatch2).solIndex(up_nodes1)];
list=[list,PHUTelem{2}(elemUpPatch2).solIndex(up_nodes2)];
list=[list,PHUTelem{1}(elemDownPatch1).solIndex(down_nodes1)];
list=[list,PHUTelem{1}(elemDownPatch1).solIndex(down_nodes2)];
list=[list,PHUTelem{2}(elemDownPatch2).solIndex(down_nodes1)];
list=[list,PHUTelem{2}(elemDownPatch2).solIndex(down_nodes2)];
