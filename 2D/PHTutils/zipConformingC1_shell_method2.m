function [PHUTelem,m] =zipConformingC1_shell_method2(PHUTelem,GIFTmesh,patchBoundaries,solIndexCount,p,q)
...
for boundaryIndex = 1:numBoundaries
    ...
    for indexPatch=1:length(patchAList)
        ...
        [m,i] = computeMatrixM_shell_method2(PHUTelem,GIFTmesh,patchInfo,m,i,p,q,numPts);
