function [l2relerr] =calcErrorNormsBiharmonic_square_degElev(PHTelem, GIFTmesh,  p, q, sol0 )
%use C1NodesGlobal
...
for patchIndex = 1:length(PHTelem)
    for i=1:length(PHTelem{patchIndex})
        if isempty(PHTelem{patchIndex}(i).children)
            ...
            %globalNodes=PHTelem{patchIndex}(i).C1NodesGlobal;
