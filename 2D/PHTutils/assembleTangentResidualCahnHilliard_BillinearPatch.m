function [ tangent, residual ] = assembleTangentResidualCahnHilliard_BillinearPatch( PHTelem, basisFun, sizeBasis, p, q,C,Cdot,theta,alpha,shift)
        ...
        if isempty(PHTelem{patchIndex}(elemIndex).children)
            ...
            for jj=1:ngauss_y
                for ii=1:ngauss_x
                    ...
                    dxdxi2 = basisFun.dxdxi2{patchIndex,elemIndex,ii,jj};
                    ...
                    %tangent part 
                    [localC, dLocalC, del2_c,localC_t]=computeConcentrationInfoC1_billinearPatch(tempC,tempCdot,R,dRdx,dRdy,d2Rdx,d2Rdy,d2Rdxdy,dxdxi,d2xdxi2, dxdxi2);
