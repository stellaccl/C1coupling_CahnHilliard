...
%disp('in assemble tangnet residual')
%Gauss points
ngauss_x = p+1;
ngauss_y = q+1;
...
%                     pause
                    ...
                    %tangent part  computeConcentrationInfoC1_billinearPatch
...
%                    save('localResidualTempAssembleTangentResidual.mat','localResidualTemp')
%                    disp('finish save ')
%                     pause
