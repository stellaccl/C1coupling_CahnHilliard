function [m,i] = computeMatrixM_shell_method2(PHUTelem,GIFTmesh,patchInfo,m,i,p,q,numPts)
...
for indexSeg=1:length(elemA)
    ...
    for ic=1:numPts
        ...
        [coords,dxdxi_PatchA] = paramMapShell(GIFTmesh{patchA},urefA,vrefA, xminPatchA, yminPatchA, xmaxPatchA, ymaxPatchA);
        [coords,dxdxi_PatchB] = paramMapShell(GIFTmesh{patchB},urefB,vrefB, xminPatchB, yminPatchB, xmaxPatchB, ymaxPatchB);
        ...
        [m] = assignContinuityConstraints_shell_method2(solIndex,basisIndex,m,i,dR_patchA,dR_patchB);
